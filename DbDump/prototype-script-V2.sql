...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `Name` varchar(45) NOT NULL, /*Important to have names for clients*/
  `Username` varchar(45) DEFAULT NULL, /*Username could be manually set or automatically generated*/
  `Email` varchar(100) NOT NULL, /*Email details are required, such as for sign-in*/
  `Password` varchar(45) DEFAULT NULL, /*Password in this case is not salted and hashed, this could be done in a future iteration*/
  `Account_Status` varchar(45) DEFAULT 'Active', /*Accounts will be in use by default, therefore status should be Active*/
  PRIMARY KEY (`Client_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS `professionals` (
  `Professional_Id` bigint NOT NULL AUTO_INCREMENT, /*Professionals are assigned an Id*/
  `Name` varchar(45) NOT NULL, /*Important to have names for professionals*/
  `Username` varchar(45) DEFAULT NULL, /*Username could be manually set or automatically generated*/
  `Email` varchar(100) NOT NULL, /*Email details are required, such as for sign-in*/
  `Password` varchar(45) DEFAULT NULL, /*Password in this case is not salted and hashed, this could be done in a future iteration*/
  `Account_Status` varchar(45) DEFAULT 'Active', /*Accounts will be in use by default, therefore status should be Active*/
  `Professional_Type` varchar(45) DEFAULT NULL, /*There will be different types of professionals, this info needs to be stored*/
...
CREATE TABLE IF NOT EXISTS `address` (
    ...
    `Suburb` varchar(45) DEFAULT NULL, /*Suburb of the Address*/
...
CREATE TABLE IF NOT EXISTS `membership` (
    ...
    `Membership_Type` varchar(45) DEFAULT NULL, /*Subscription/On Demand etc*/
...
CREATE TABLE IF NOT EXISTS `service_request` (
    ...
    `Request_Type` varchar(45) NOT NULL, /*This sets the type of request being made, such as "clean gutters"*/
    `Request_Description` varchar(500) DEFAULT NULL, /*A more detailed description of the issue (if one is provided)*/
    `Request_Status` varchar(45) DEFAULT NULL, /*Pending (Submitted but not Accepted), Accepted, Completed, etc*/
...
CREATE TABLE IF NOT EXISTS `payment` (
    ...
    `Payment_Type` varchar(45) NOT NULL, /*Service Request or Membership etc*/
    `Payment_Amount` int DEFAULT NULL, /*Amount of money being paid*/
    `Card_Number` varchar(45) DEFAULT NULL, /*Card details for payment*/
...
CREATE TABLE IF NOT EXISTS `ratings` (
    ...
    `Rating_Description` int DEFAULT NULL, /*Optional ability to add a description to their rating*/
